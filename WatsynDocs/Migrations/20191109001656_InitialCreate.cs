    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    KeynoteID = table.Column<Guid>(nullable: false),
                    KeynoteTitle = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Keynote", x => x.KeynoteID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SpreadsheetID = table.Column<Guid>(nullable: false),
                    SpreadsheetTitle = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
